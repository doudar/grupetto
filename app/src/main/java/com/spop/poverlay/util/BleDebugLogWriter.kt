...
class BleDebugLogWriter(private val context: Context) {
    companion object {
        const val FileName = "grupetto-ble-debug.log"
        private const val Tag = "BleDebugLogWriter"
    ...
    fun append(level: String, message: String, throwable: Throwable? = null) {
        ...
        synchronized(lock) {
            runCatching {
                ...
                Log.e(Tag, "Failed to append BLE debug log", it)
            }
        }
    }
